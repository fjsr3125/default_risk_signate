...
#いらないデータを落とす
train = train.drop(["id", "loan_amnt", "interest_rate",  "employment_length"], axis = 1)
test  = test.drop(["id", "loan_amnt", "interest_rate",  "employment_length"], axis = 1)

train = train.dropna()

report.show_html("eda_log.html")
